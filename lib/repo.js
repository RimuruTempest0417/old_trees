 ...
 */
const SCHEMA_PROBES = [
  { label: '檢視表 v_trees（含市政署欄位）', table: 'v_trees', columns: 'tree_no,official_no,geo_precision,photo_url,official_age_years' },
  { label: '資料表 trees', table: 'trees', columns: 'tree_no,species,age_years,height_m,lat,lon' },
  ...
  { label: '資料表 routes（路綫）', table: 'routes', columns: 'slug,site_names' },
];
const RPC_PROBES = [
