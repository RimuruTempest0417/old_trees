...
export const SCHEMA_PROBES = [
  { label: '檢視表 v_trees（含市政署欄位）', table: 'v_trees', columns: 'tree_no,official_no,tree_geo_precision,geo_precision,tree_photo,official_age_years' },
...
export const API_VERSION = 'v0.6.6';
