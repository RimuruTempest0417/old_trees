...
export const ROUTES = [
  ...
  { id: 'priority', path: '/api/priority' },
  { id: 'env-chem', path: '/api/env-chem' },
  { id: 'monitoring', path: '/api/monitoring' },
  { id: 'field-records', path: '/api/field-records' },
  { id: 'photo', path: '/api/photo' },
  { id: 'policy', path: '/api/policy' },
];
...
const LOADERS = {
  ...
  photo: () => import('./routes/photo.js'),
  policy: () => import('./routes/policy.js'),
  priority: () => import('./routes/priority.js'),
  'env-chem': () => import('./routes/env-chem.js'),
  monitoring: () => import('./routes/monitoring.js'),
};
